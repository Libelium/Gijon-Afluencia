...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="{{ app()->getLocale() }}">
 <head>
  ...
  <title>{{ __('emails.criticalIncident.title') }}</title>
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none" style="border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
             <tr>
              <td align="left" bgcolor="#d92d20" style="Margin:0;padding:30px 40px;background-color:#d92d20">
               <p style="Margin:0;font-family:Poppins, sans-serif;line-height:30px;letter-spacing:0;color:#FFFFFF;font-size:22px"><strong>&#9888; {{ __('emails.criticalIncident.banner') }}</strong></p>
              </td>
             </tr>
             <tr>
              <td align="left" style="Margin:0;padding:40px 40px 10px 40px">
               <p style="Margin:0;font-family:Poppins, sans-serif;line-height:27px;letter-spacing:0;color:#686868;font-size:18px"><strong>{{ __('emails.criticalIncident.intro') }}</strong></p>
               <p style="Margin:16px 0 0 0;font-family:Poppins, sans-serif;line-height:24px;letter-spacing:0;color:#686868;font-size:16px">{{ __('emails.criticalIncident.referenceLabel') }} <strong>{{ $ref }}</strong></p>
               @if(!empty($category))
               <p style="Margin:6px 0 0 0;font-family:Poppins, sans-serif;line-height:24px;letter-spacing:0;color:#686868;font-size:16px">{{ __('emails.criticalIncident.categoryLabel') }} <strong>{{ $category }}</strong></p>
               @endif
               @if(!empty($customMessage))
               <p style="Margin:20px 0 0 0;font-family:Poppins, sans-serif;line-height:24px;letter-spacing:0;color:#686868;font-size:16px">{{ $customMessage }}</p>
               @endif
              </td>
             </tr>
             <tr>
              <td align="left" style="Margin:0;padding:20px 40px 40px 40px">
               ...
               <p style="Margin:0;font-family:Poppins, sans-serif;line-height:24px;letter-spacing:0;color:#686868;font-size:16px">{{ __('emails.common.teamSignature') }}</p>
              </td>
             </tr>
             <tr>
